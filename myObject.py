...
class Animal:
    #note __ is show that attribute is private
    __name= ""
    __height=0
    __weight= 0
    __sound =0
...
spot = Dog("Spot", 34, 20,"Ruff", "Shelema")
...
testing_animal = AnimalTesting()
testing_animal.get_type(cat)
testing_animal.get_type(spot)